...
class FoodViewModel @Inject constructor(
	...
	val foodRoutes = listOf(
		FoodRoute(
			name = "Churrasco",
			route = "bbqs",
			image = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTl0zPT9JnZjHZCKFFHzIPbe0wS7MlwE568EQ&s"
		),
		FoodRoute(
			name = "Melhores Alimentos",
			route = "best-foods",
			image = "https://wx.mlcdn.com.br/ponzi/production/portaldalu/43344_01.jpg"
		),
		FoodRoute(
			name = "Pães",
			route = "breads",
			image = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQGBjevCIICr24E66wMO9CWPSHathASA35R8Q&s"
		),
		FoodRoute(
			name = "Hambúrgueres",
			route = "burgers",
		...
		FoodRoute(
			name = "Chocolates",
			route = "chocolates",
			image = "https://ecp.yusercontent.com/mail?url=https%3A%2F%2Fcseprs3.s3.amazonaws.com%2Femail-editor-files%2Faee2f952-3231-436d-a46e-08d9f0b2efaa%2F7cb62c07-dd0b-4932-a21e-107ea18283b8.jpg&t=1720194785&ymreqid=3ea9396a-53ac-76b5-1c06-b70008010500&sig=eDz4lnJyH6Htraf2J7zCQA--~D"
		),
		FoodRoute(
			name = "Sobremesas",
			route = "desserts",
			image = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQXW098aMgh0oLDONxBtWs2ff1DHYS2gYo6HA&s"
		),
		FoodRoute(
			name = "Bebidas",
			route = "drinks",
			image = "https://conteudo.imguol.com.br/c/entretenimento/74/2022/09/13/drinques-bebida-alcoolica-tequila-cerveja-chopp-gim-martini-alcool-copos-tacas-1663094165597_v2_4x3.jpg"
		),
		FoodRoute(
			name = "Frango Frito",
			route = "fried-chicken",
			image = "https://pubimg.band.uol.com.br/files/814f09873d737cbc500d.png"
		),
		FoodRoute(
			name = "Sorvetes",
			route = "ice-cream",
			image = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTp98KIc66cgKAPeOwIBnqKb9xeoHIFXf8wMA&s"
		),
		FoodRoute(
			name = "Pizzas",
			route = "pizzas",
			image = "https://istoe.com.br/wp-content/uploads/2023/07/feche-a-pizza-italiana-sobre-o-queijo-cole-o-foco-seletivo-generativo-ai-1258-153047.jpeg"
		),
		FoodRoute(
			name = "Carnes de Porco",
			route = "porks",
			image = "https://www.juliatto.com.br/wp-content/uploads/2023/05/preparar-carne-de-porco-de-forma-saudavel.jpg"
		),
		FoodRoute(
			name = "Sanduíches",
			route = "sandwiches",
			image = "https://www.unochapeco.edu.br/static/data/portal/noticias/fotos/960x960/9879.jpg"
		),
		FoodRoute(
			name = "Salsichas",
			route = "sausages",
			image = "https://conteudo.imguol.com.br/c/entretenimento/0c/2018/09/18/tipos-de-linguicas-1537301783500_v2_900x506.jpg"
		),
		FoodRoute(
			name = "Bifes",
			route = "steaks",
			image = "https://www.pingodoce.pt/wp-content/uploads/2016/06/bifes-angus-com-presunto.jpg"
		),
		FoodRoute(
			name = "Nossos Alimentos",
			route = "our-foods",
			image = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQfQtp6m__wPVhZ4Jv99xneEo4ESOTX9WbZGG0r2dNTqeBdMWFuxdbM7FGiMs-PmnY4QIs&usqp=CAU"
		)
	)
	...
	fun clearErrorMessage(route: String) {
		_errorMessage.value = null
		fetchFoodItems(route)
	}
